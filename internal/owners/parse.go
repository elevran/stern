...
func LoadForPaths(ctx context.Context, ghc ghclient.ContentClient, owner, repo, ref string, changedPaths []string) (*ResolvedOwners, error) {
...
func loadAliases(ctx context.Context, ghc ghclient.ContentClient, owner, repo, ref string) (*Aliases, error) {

...
func LoadForPaths(ctx context.Context, ghc ghclient.Client, owner, repo, ref string, changedPaths []string) (*ResolvedOwners, error) {
...
func loadAliases(ctx context.Context, ghc ghclient.Client, owner, repo, ref string) (*Aliases, error) {
